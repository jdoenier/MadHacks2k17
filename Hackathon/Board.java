...
//		pacmans= new Pacman [MAX_PACS];
//		for (int i = 1; i < N_PACS; i ++ ){
//			pacmans[i] = new Pacman (this);
//		}
	...
	private void playGame(Graphics2D g2d) {
		...
		if (dying){
			...
			for(int i = 0; i < N_PACS; i ++){
				pacmans[i].move(this);
				drawPacman(g2d, pacmans[i]);
			}
...
//		}
	...
	private void loadImages() {
        ...
        ghostLeft = new ImageIcon("images/ghostLeft.png").getImage();
        ghostRight = new ImageIcon("images/ghostRight.png").getImage();
        ghostUp = new ImageIcon("images/ghostUp.png").getImage();
        ghostDown = new ImageIcon("images/ghostDown.png").getImage();
	...
	private void continueLevel() {
		...
		for (i = 0; i < N_PACS; i++) {
			...
			pacmans[i] = new Pacman (this, 4 * BLOCK_SIZE, 4 * BLOCK_SIZE, dx, 0, speed, -1, 0 );
			
			dx = -dx;
		}
		
		ghost = new Ghost(this, 7 * BLOCK_SIZE, 11 * BLOCK_SIZE, -1, 0, -1, 0 );
